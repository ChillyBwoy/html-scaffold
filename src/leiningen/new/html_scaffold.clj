...
(defn html-scaffold
  ...
  (let [data {:name name
    ...
    (->files data
      ...
      ["src/clj/{{sanitized}}/components/page.clj"    (render "src/clj/new/components/page.clj" data)]
      ...
      ["src/clj/{{sanitized}}/utils/helpers.clj"      (render "src/clj/new/utils/helpers.clj" data)]
      ...
      ["src/css/{{sanitized}}/components/page.css"    (render "src/css/new/components/page.css" data)]
      ...
      ["src/css/{{sanitized}}/views/style.css"        (render "src/css/new/views/style.css" data)]
